...
#Right_arm.run_angle(400, 400)
    ...
    drive_base.turn(-22)
    drive_base.settings(50, 800, 100, 200)
    drive_base.straight(-60)
    drive_base.settings(550, 800, 100, 200)
...
# HEAD TO M03 AND EXECUTE
    ...
    wait(400)
    drive_base.settings(40, 800, 20, 200)
    drive_base.straight(-80)

# COMPLETE  M03

# HEAD TO M05 AND EXECUTE
    drive_base.settings(600, 1000, 200, 400)
    drive_base.turn(12)
##    Left_arm.run_angle(900, -900, wait=False)
## IMPORTANT CODE THAT SKIPS HOLOGRAM PERFORMER (IF NEEDED, UNCOMMENT THE ##)
##    drive_base.straight(539)
##    drive_base.turn(-32)
##    drive_base.settings(200, 800, 800, 1000)
##    drive_base.straight(120)
##    drive_base.settings(600, 800, 900, 1000)
##    drive_base.turn(84)
# COMPLETE M05
...
##    drive_base.turn(-48)
    drive_base.straight(1120)
    
##    drive_base.straight(420)

    drive_base.turn(-35)
    drive_base.settings(300, 500, 200, 400)
...
#CODE FOR M06 and RIGHT LEVER STARTS HERE
    drive_base.straight(110, wait=False)
    wait(1500)
    drive_base.turn(-15, wait=False)
...
#the last expert Emily
    ...
    drive_base.straight(67) #getting stuck 
...
#Curve to align
    ...
    Left_arm.run_angle(400,540,wait=False)
    #to the homebase
    #Cg=heckhere
