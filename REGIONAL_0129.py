...
#POSITIONING THE ROBOT FOR M06 and M07
    ...
    drive_base.turn(-41)
    drive_base.settings(150, 200, 200, 400)
...
#CODE FOR M06 and RIGHT LEVER STARTS HERE
    drive_base.straight(90, wait=None)
    wait(1500)
    drive_base.turn(-5)
...
#Reduce speed to move the mixer
    ...
    #drive_base.settings(23, 100, 100, 200) - worked with -3
    drive_base.settings(18, 100, 100, 200)
    #Engage with the knobs
