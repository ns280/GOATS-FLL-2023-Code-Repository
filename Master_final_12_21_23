...
#Pickup izzy girl No wait false. Not enough distance
    ...
    drive_base.turn(-0.5)
#Reach Chicken gear
#drive_base.straight(124) avoid yellow gear
    drive_base.straight(114)
    drive_base.turn(0.75)
    drive_base.turn(0.25)
#Moving the chicken
#wait(5000)
    Left_arm.run_target(1000, 3000)
    drive_base.turn(-0.50)
#Chicken done
...
# Right_arm.run_angle(200, -540, wait=False) # TESTING
#MAIN CODE drive_base.straight(45)
#MAIN CODE drive_base.curve(200,-62)
...
#Sound mixer
    Left_arm.dc(100)
#Left_arm.run_angle(100,-115,wait=False)
